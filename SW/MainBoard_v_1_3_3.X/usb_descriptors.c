/*******************************************************************************
 ...
 Hardware:		The code is natively intended to be used on the following
                                ...
                                Explorer 16 + PIC24 USB PIM, or Explorer 16 + PIC32 USB PIM.
                                The firmware may be modified for use on other USB platforms
                                by editing the HardwareProfile.h file.

 Complier:  	Microchip C18 (for PIC18), C30 (for PIC24) or C32 (for PIC24)
...
calculate the length of string descriptor sdxxx, where xxxx is the
