...
/**
 * \struct LCD 
 * \brief structure contenant 
 */
typedef struct __attribute__((packed))
{
    QueueHandle_t queue; /*!<Handle de la queue contenant les informations à envoyer à l'afficheeur.*/
    BYTE toLCD[2]; /*!<Buffer contenant un caractère ou une commande à envoyer à l'afficheur.*/
    BYTE LastAddressCursor; /*!<Adresse dans l'afficheur.*/
}
LCD;
...
/**
 * \var display
 * \brief variable structure contenant les variables de l'afficheur.
 */
LCD display;
