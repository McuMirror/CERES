...
#ifdef __L_DEBUG
static const char Version[] = "Rev 1.2.15";
#else
static const char Version[] = "Rev 1.2.15";
#endif
...
/**
 * \def ONBOARDBUTTON
 * \brief port du bouton sur la carte mère.
 */
 ...
 * bouton sur la carte positonne le port et éteint le buzzer et positionne les
 ...
 * \brief Gestion des touches activées ou du bouton de test activé.
 * @param pvParameter Paramètre obligatoire pour toutes les tâches de FreeRTOS.
 */
 ...
 * \param[in] boDelay Indique si le montant doit rester afficher quelques instants
 */
 ...
 * \param[in] boEnable Permet l'affichage du flag d'activation ou de desactivation.
 */
 ...
 * @param boEnable Indique si la denomination est activée ou non.
 */
 ...
 * \param[in] boEnable Booléen indiquant si les périphériques doivent être activés ou non
 ...
 */
BOOL boCodeCheck(const WORD wEEAddress);
 ...
 * @param iBuzzerLen
 */
void vStartBuzzer(BOOL boActivel, int iBuzzerLen);
