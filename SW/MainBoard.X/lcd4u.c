 ...
 * Note:            None
 ********************************************************************/
void CreateChar(const BYTE Code, const BYTE *pBuffer)
{
    BYTE byIndex;
    SetCGRamAddr(Code * 8);
...
//    //DelayMs(100);
//
//    //Positionne les lignes de commande à l'état bas
//    PORTClearBits(LCD_PORT, LCD_BUS);
//    //Tout le ports en sortie et à l'état bas.
...
//    //Stabilisation de l'alimentation
//    DelayMs(150);
//    //Function set interface 4 bits long.
//    //8 BITS
//    //  PORTSetBits(LCD_PORT, 0X3 << 4);
//
//    //4 bits opération
//    //Voir le manuel HD44780U (LCD-II) ADE-207-272(Z) '99.9 Rev. 0.0 page 42 Table 12 Ligne 2
//    PORTSetBits(LCD_PORT, BIT_5);
//    LCD_Clock();
//    DelayMs(5);
//    //Function set interface 4 bits long.
//    //8 BITS
//
//    //Repositionne tous le bus de data à l'état bas.
//    LCD_RESET_PORT_DATA();
//    //	PORTSetBits(LCD_PORT, 0X2 << 4);
//
//    //4 bits opération
//    //Voir le manuel HD44780U (LCD-II) ADE-207-272(Z) '99.9 Rev. 0.0 page 42 Table 12 Ligne 3
//    PORTSetBits(LCD_PORT, BIT_5);
//    LCD_Clock();
//    DelayMs(5);
//    //Function set interface 8 bits long.
//    //4 bits
//
//    //Repositionne tous le bus de data à l'état bas.
//    LCD_RESET_PORT_DATA();
//    //Selectionne le nombre de ligne
//    //Voir le manuel HD44780U (LCD-II) ADE-207-272(Z) '99.9 Rev. 0.0 page 42 Table 12 Ligne 3
//    if(byNumLignes > 1)
//    {
//        PORTSetBits(LCD_PORT, BIT_7);
//    }
//    LCD_Clock();
//    DelayMs(2);
//
...
//    DelayMs(200);
//
//    boLCDInitialized = TRUE;
//
//    //Attend au maximum 255 fois que le controleur soit libre.
//    while(--byIndex && LCD_IsBusy());
//    DelayMs(200);
//    //Si byIndex est égal à 0, le contrôleur ne fonctionne pas
//    //TODO remettre en place
//    boLCDInitialized = byIndex > 0;
//    while(LCD_IsBusy());
//    LCDSetValue(0X28);
//    DelayMs(2);
//    while(LCD_IsBusy());
