 ...
 */
#define MDB_TO (2 * SECONDE)
//#define MDB_TO 200 * MILLISEC
 ...
 */
#define MDBPOLLINMS (250 * MILLISEC)
 ...
 */
#define MDBRETRY (BYTE)((60 * SECONDE) / MDBPOLLINMS)
 ...
 */
SemaphoreHandle_t semaphoreChange;
...
/**
 * \brief Fonction de contrôle ou de géneration du checksum.
 * \param[in] byLen Nombre de caractère à additionner.
 * \param[in] ptrBuffer Pointeur sur le buffer qui contient les données à vérifier.
...
/**
 * \brief Le time out pour recevoir une réponse est dépassé.
 */
...
SemaphoreHandle_t semaphoreMDB;
