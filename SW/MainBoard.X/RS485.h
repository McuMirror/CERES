...
/**
 * \fn RS485GetS
 * \brief Lit une chaine de cartactères sur le port RS485
 * @param pBuffer Buffer qui contiendra la chaine de cartactères reçue.
 * @return Le nombre de caractère de la chaine.
 */
...
/**
 * \fn RS485WriteS
 * \brief Transmet une chaine de caractères sur la ligne 485.
 * @param[in] pBuffer Buffer contenant la chaine de caractère à transmettre.
 * @return Le nombre de byte réellement transmis.
 */
 ...
 * @param[in] cData Octet à tranmettre.
 */
void RS485WriteByte(const BYTE cData);

/**
 * \fn RS485GetByte
 * \brief Attend un caractère sur la ligne 485.
