...
BOOL boReceiveAnswer(BYTE byNumMachine, BYTE byNewNumMachine)
{
    BYTE byToto, byToto1;
    byToto = byNumMachine;
...
BOOL boSendCommand(const BYTE byNumMachine, const BYTE byHeader,
                   const BYTE byLenData, const void *byData)
{
    WORD wLCRC;
    BYTE byRetry = 4;
    ...
    while(!boReceiveAnswer(byNumMachine, byNewMachine) && --byRetry);
    return (byRetry > 0);
}

/******************************************************************************/

BOOL boModifyMachineNumber(const BYTE byOldNumMachine, BYTE byNewNumMachine)
{
    BOOL boResult;
    ...
    boResult = boSendCommand(byOldNumMachine, MODIFY_MACHINE_NUMBER, sizeof (byNewNumMachine), &byNewNumMachine);
    return boResult;
}

/******************************************************************************/

BOOL boSimplePoll(const BYTE byNumMachine)
{
    //    vSendCommand(byNumMachine, SIMPLEPOLL, 0, NULL);
    //    memset(bySatBuffer, 0, sizeof (bySatBuffer));
    //    return boReceiveAnswer(byNumMachine);
    return boSendCommand(byNumMachine, SIMPLEPOLL, 0, NULL);
}
...
BOOL isMainPresent(const BYTE byNumMachine)
{
    ...
    //    }
    //    return ABSENT;
    if(boSendCommand(byNumMachine, REQUEST_ISMAINPRESENT, 0, NULL))
    {
        return (EPRESENT)bySatBuffer[4];
    }
    return ABSENT;
...
BOOL boModifyMachineRelayState(const BYTE byNumMachine, const ESTATE relayState)
{
    ...
    //    return boReceiveAnswer(byNumMachine);
    BYTE byRelayState = (BYTE)relayState;
    return boSendCommand(byNumMachine, MODIFY_MACHINE_RELAY_STATE, 1, &byRelayState);
}

/******************************************************************************/

BOOL boExModifyMachineRelayState(const BYTE byNumMachine, const DWORD dwDelayActivation)
{
    ...
    //    return boReceiveAnswer(byNumMachine);
    DWORD dwActivation = dwDelayActivation;
    return boSendCommand(byNumMachine, MODIFY_MACHINE_RELAY_STATE, sizeof (dwActivation), &dwActivation);
}
...
ESTATE getMachineRelayState(const BYTE byNumMachine)
{
    ...
    //    }
    //    return RELAY_OFF;
    if(boSendCommand(byNumMachine, REQUEST_MACHINE_RELAY_STATE, 0, NULL))
    {
        return (ESTATE)bySatBuffer[4];
    }
    return RELAY_OFF;
...
BOOL vSetMainPowerRelayState(const BYTE byNumMachine, const ESTATE relayState)
{
    ...
    //    return boReceiveAnswer(byNumMachine);
    BYTE byRelayState = (BYTE)relayState;
    return boSendCommand(byNumMachine, MODIFY_MAIN_POWER, 1, &byRelayState);
}
...
ESTATUS getMachineState(const BYTE byNumMachine)
{
    ...
    //    }
    //    return MACHINE_BUSY;
    if(boSendCommand(byNumMachine, REQUEST_MACHINE_STATUS, 0, NULL))
    {
        return (ESTATUS)bySatBuffer[4];
    }
    return MACHINE_BUSY;
...
BOOL boSetOverBusyDelay(const BYTE byNumMachine, DWORD dwOverBusyDelay)
{
    //    vSendCommand(byNumMachine, MODIFY_DELAY_OVER_BUSY, sizeof (dwOverBusyDelay),
    //            &dwOverBusyDelay);
    //    memset(bySatBuffer, 0, sizeof (bySatBuffer));
    //    return boReceiveAnswer(byNumMachine);
    return boSendCommand(byNumMachine, MODIFY_DELAY_OVER_BUSY, sizeof (dwOverBusyDelay),
                         &dwOverBusyDelay);
}

/******************************************************************************/

BOOL boSetSensibility(const BYTE byNumMachine, WORD wSensibility)
{
    //    vSendCommand(byNumMachine, MODIFY_BUSY_LEVEL, sizeof (wSensibility),
    //            &wSensibility);
    //    memset(bySatBuffer, 0, sizeof (bySatBuffer));
    //    return boReceiveAnswer(byNumMachine);
    return boSendCommand(byNumMachine, MODIFY_BUSY_LEVEL, sizeof (wSensibility),
                         &wSensibility);
}
...
DWORD dwGetOverBusyDelay(const BYTE byNumMachine)
{
    ...
    //        return dwResult;
    //    }
    if(boSendCommand(byNumMachine, REQUEST_DELAY_OVER_BUSY, 0, NULL))
    {
        memmove(&dwResult, &bySatBuffer[4], sizeof (dwResult));
        return dwResult;
    }
...
ELEVEL boGetMachineFull(const BYTE byNumMachine)
{
    ...
    //    }
    if(boSendCommand(byNumMachine, REQUEST_MACHINE_LEVEL, 0, NULL))
    {
        return (ELEVEL)bySatBuffer[4];
    }
    return NOTEMPTY;
...
WORD wGetSatelliteFWVersion(const BYTE byNumMachine)
{
    ...
    //        return wResult;
    //    }
    if(boSendCommand(byNumMachine, REQUEST_FW_VERSION, 0, NULL))
    {
        memmove(&wResult, &bySatBuffer[4], sizeof (wResult));
        return wResult;
    }
