 ...
 */
BOOL isGetMDBChangerID(ChangerIdentification *byID);

/**
 * \fn isGetMDBTubeStatus
 ...
 * \return True Si la lecture s'est terminée correctement.
 */
BOOL isGetMDBTubeStatus(TubeStatus *tubeStatus);
 ...
 */
BOOL isEnableChanger(const BOOL boEnable, CoinType *coinType);
