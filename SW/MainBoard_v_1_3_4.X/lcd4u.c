...
/** ****************************************************************************
 * \file            lcd4u.c                    
 * \brief			Sources de la gestion de l'afficheur
 * \date            2013.11.30                                                 
...
void LCDInit(const BYTE byNumLignes)
{
    ...
    //Fonction set--------------------------------------------------
    //MSB bits    
    LCD_RESET_PORT_DATA(); //0
    LCD_Clock();
    //--------------------------------------------------------------------------

    PORTSetBits(LCD_PORT, DB6 | DB5); //60
    LCD_Clock();
    //-----------------------    
    //Wait time > 40us
    DelayMs(1);
    ...
    PORTSetBits(LCD_PORT, DB7 | DB6 | DB5); //0X0E
    LCD_Clock();
    //-----------------------    
    //Wait time > 40us
    DelayMs(1);
...
/*********************************************************************
 * Function:        void setLCDAddressCounter(const BYTE byAddress)
 *
 * PreCondition:    None
 *
