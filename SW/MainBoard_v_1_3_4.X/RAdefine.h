...
/** ****************************************************************************
 * \file            RAdefine.h                                                 
 * \brief			Header des definitions specifique
 * \date            2013.11.30                                                 
...
/**
 * \def SECONDE
 * \brief Nombre de tick pour une seconde dans FreeRtos.
 */
#define SECONDE (1000 / portTICK_RATE_MS)

/**
 * \def MILLISEC 
 * \brief Nombre de tick pour une milliseconde dans FreeRtos.
 */
#define MILLISEC (1 / portTICK_RATE_MS)

/**
 * \def BASEYEAR
 * \brief Année de référence dans les calculs de date.
 */
...
/**
 * \union UBUSYLEVEL
 * \brief union contenant le niveau de sensiblité d'un module.
 */
typedef union
{
    uint16_t wBusyLevel; /*!<Sensiblité du module de 0 à 65535.*/
    BYTE byBusyLevel[sizeof (uint16_t)]; /*!<Conversion en tableau d'octets de la sensibilité d'un module*/
} UBUSYLEVEL;
