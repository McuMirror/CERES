...
/** ****************************************************************************
 * \file            satellites.c                                                 
 * \brief           Sources de la gestion des satellites
 * \date            2013.11.30                                                 
...
static WORD wCRC16(const BYTE *byData, const BYTE byLen)
{
...
static BOOL isReceiveAnswer(BYTE byNumMachine, BYTE byNewNumMachine)
{
    WORD wCRC;
    SETREAD();
...
static BOOL isSendCommand(const BYTE byNumMachine, const BYTE byHeader,
...
BOOL isSetMainPowerRelayState(const BYTE byNumMachine, const ESTATE relayState)
{
    BYTE byRelayState = (BYTE)relayState;
