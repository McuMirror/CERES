...
/** ****************************************************************************
 * \file            textes.h                                                 
 * \brief			Fichier contenant les textes
 * \date            2013.11.30                                                 
...
/**
 * \var byTexte
 * \brief Tableau de contenant les textes en mode majuscules.
 */
char *byTexte[] = {
...
/**
 * \var byTexte
 * \brief Tableau de contenant les textes.
 */
char *byTexte[] = {
                   "Selection machine:", //SELECTION_MACHINE, 0
                   "Piece:", //COIN, 1
...
/**
 * \enum ETEXTE
 * \brief Enumeration des numéros de ligne
 */
enum __attribute__((packed)) ETEXTE
{
    SELECTION_MACHINE, //0
        COIN, //1
        BILL, //2
