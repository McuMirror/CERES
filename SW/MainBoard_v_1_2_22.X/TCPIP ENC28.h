 ...
 */
#define MY_DEFAULT_HOST_NAME			"MDI"
...
#define MY_DEFAULT_MAC_BYTE5            (0x10)	// internal factory programmed MAC
 ...
 */
	...
	#define TCP_ETH_RAM_SIZE					(8433ul)
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			//{TCP_PURPOSE_GENERIC_TCP_CLIENT, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_GENERIC_TCP_SERVER, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_TELNET, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_TELNET, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_TELNET, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_FTP_COMMAND, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_FTP_DATA, TCP_ETH_RAM, 0, 1},
			{TCP_PURPOSE_TCP_PERFORMANCE_TX, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_TCP_PERFORMANCE_RX, TCP_ETH_RAM, 0, 1},
			//{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_ETH_RAM, 0, 1},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1024, 1024},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1024, 1024},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1024, 1024},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1024, 1024},
			//{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 0, 1},
		};
