...
#ifndef __L_DEBUG
static const char Version[] = "Rev 1.2.22";
#else
static const char Version[] = "Rev 1.2.22D";
#endif
...
//Version 1.2.2
#pragma config FWDTEN = ON             // Watchdog Timer Disable (WDT Enable (SWDTEN Bit Controls))
//-------------
